...
#  дозволяет небольшое отрицательное значение для отрицательных входов, что помогает избежать "мертвых нейронов"
...
# извлечение всех обучаемых переменных из scopes
...
# объединение двух входов x и y, линейное преобразование и активация Leaky ReLU
...
# полносвязный слой с двумя линейными преобразованиями
...
# позволяет дифференцировать выбор категориальных переменных, добавляя шум для получения вероятностей
...
# различные способы выборки слов из распределения вероятностей, полученного от модели
...
# декодирование с использованием RNN
...
# декодирование с использованием СNN
...
# дискриминатор для GAN, принимает реальные и сгенерированные данные, вычисляет потери и, если используется WGAN, добавляет штраф для улучшения обучения
